...
export default function Header({ totalPosts, savedCount, totalUsers, isDarkMode }) {
  return (
    <header className={`relative overflow-hidden rounded-3xl p-8 sm:p-12 mb-10 transition-all ${
      isDarkMode 
      ...
      <div className="relative z-10 max-w-3xl">
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-indigo-400/20 text-indigo-200 text-xs font-bold border border-indigo-400/30 backdrop-blur-md mb-4">
        ...
        {/* Resolved Features: Combined Trending Topics + Rating Metrics */}
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="px-2.5 py-1 rounded-lg bg-white/10 text-white border border-white/20 font-medium">#Technology</span>
            <span className="px-2.5 py-1 rounded-lg bg-white/10 text-white border border-white/20 font-medium">#WebDesign</span>
            <span className="px-2.5 py-1 rounded-lg bg-white/10 text-white border border-white/20 font-medium">#Insights</span>
          </div>

          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-amber-400/20 text-amber-200 border border-amber-400/30 font-semibold backdrop-blur-md">
